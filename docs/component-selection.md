...
|![LM2576HVS-3.3](assets/Component%20Selection/LM2575HVS-3.3.png)             | Large footprint makes hand soldering easier                                                 |   Unfamiliar Manufacturer                 |
...
|![LM2574M-3.3](assets/Component%20Selection/LM2674M-3.3.png)| Pins have good spacing for hand soldering | Smallest component that could likely be hand soldered|
...
|![LM2676S-3.3](assets/Component%20Selection/LM2676S-3.3.png)| Large footprint make it easy to handle | More expensive than another option |
...
|![LM2676S-3.3](assets/Component%20Selection/LM2595S-3.3.png)| Large footprint make it easy to handle | More expensive than another option |
...
#### Application
![Typical Application](assets/Component%20Selection/LM2595S%20Typical%20Application.png)
![Buck Regulator](assets/Component%20Selection/LM2595S%20Buck%20Regulator.png)
#### Footprint
![Footprint](assets/Component%20Selection/LM2595S%20Package.png)
...
|![Barrel Plug](assets/Component%20Selection/Barrel%20Plug.png)| Easy to implement | Separate cable required|
...
|![USB B](assets/Component%20Selection/Micro%20USB%20B.png)| Relatively easy to implement | Separate cable required|
...
|![Battery](assets/Component%20Selection/18650%20Battery.png)| Relatively easy to implement | Would increase board size significantly or require separate board for power|
...
#### Pinout
![Pinout](assets/ESP32/ESP32%20Pinout.png)
![Pin Table 1](assets/ESP32/ESP32%20Pin%20Definitions%201.png)
![Pin Table 2](assets/ESP32/ESP32%20Pin%20Definitions%202.png)

#### Footprint
![Footprint](assets/ESP32/ESP32%20Pin%20Dimensions.png)

#### USB OTG

![USB OTG](assets/ESP32/ESP32%20USB%20OTG.png)

#### UART

![UART](assets/ESP32/UART%201.png)
![UART2](assets/ESP32/UART%202.png)

#### LED PWM

![LED](assets/ESP32/LED%201.png)
![LED2](assets/ESP32/LED%202.png)
...
### Power Budget
![Power Budget 1](assets/Power%20Budget/Power%20Budget%201.png)
![Power Budget 2](assets/Power%20Budget/Power%20Budget%202.png)
